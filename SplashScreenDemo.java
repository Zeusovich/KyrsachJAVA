...
/**
 * <strong>Класс Splash Screen унаследован от JFrame</strong>
 *
 * <i> данный класс предназначен для работы с ознакомительным окном</i>
 *
...
public class SplashScreenDemo extends JFrame{
    ...
    static class MyComponent extends JComponent {
        ...
        protected void paintComponent(Graphics g) {
            ...
            g1.setFont(font1);
            g1.drawString(" Белорусский национальный технический университет", 100, 30);
